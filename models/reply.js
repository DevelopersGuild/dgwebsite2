...
function createReply(threadId, message, author, callback) {
...
function getAllRepliesInThread(threadId, skip, limit, callback) {
  if (skip === 0) {
    limit = (--limit);
  }
...
function countAmountOfReplies(threadId, callback) {
